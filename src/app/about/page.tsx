...
export const metadata = createPageMetadata({
  title: "About Atara",
  description: `About ${seo.siteName} — cellular wellness and intentional beauty, curated with science-backed peptide protocols.`,
  path: "/about",
});
    ...
    <div className="bg-white pt-28 pb-24 md:pt-32 md:pb-32">
      <Container size="narrow">
        ...
        <p className="mt-6 font-body text-base leading-relaxed text-archon-muted">
          {seo.description} Atara sits at the intersection of cellular
          wellness and intentional beauty — built for people who treat recovery
          and optimization as part of the lifestyle.
        </p>
        <Link
          href="/shop"
